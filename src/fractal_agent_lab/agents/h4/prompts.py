...
SEQ_NEXT_PROMPTS_BY_ROLE: dict[H4SeqNextRole, str] = {
    ...
    H4SeqNextRole.PLANNER: (
        ...
        "Return keys: step_order, dependencies, test_plan, documentation_obligations, risk_register, open_questions. Include "
        "risks as structured items suitable for an embedded risk register section in implementation_plan.md. Do not emit manager control."
    ),
