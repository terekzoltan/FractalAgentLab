...
param(
  ...
  [ValidateSet('help','open-work','amend-work','adopt-manual-continuation','submit','compact','restore','inspect','read-result','read-source','refresh-state','wait','reconcile','interpret','observe-session','record-pause','import-legacy')]
  [string]$Action,
